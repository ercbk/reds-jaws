...
A user guide for the dashboard can be found [here](https://raw.githack.com/ercbk/reds-jaws/master/docs/documentation.html).  

Details on the JAWS-4 calculation can be found [here](https://raw.githack.com/ercbk/reds-jaws/master/docs/notes.html).
